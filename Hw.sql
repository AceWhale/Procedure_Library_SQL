-- 1 Task (pishu na latishskom, tak kak github lyubit vse portity,)
-- Ne mogu ponyaty pochemu tut u menya rekursia idet, snachala vse ok... i bac, Maximum stored procedure ಠ_ಠ
...
-- Call proc
EXEC GetBooksByCriteria @AuthorFirstName = 'Сергей', @AuthorLastName = 'Никольский', @ThemeID = 4, @CategoryID = 2, @SortField = 'name', @SortDirection = 'ASC'
